...
| bonita_on_single_host    | N         | false   | Set to `True` when all containers of the Bonita stack is deployed on a single host. Works only when deploying using `static_inventory` as bcd_provider                                                                                                      | true                                                             |
