...
NOTE: Refer to https://docs.ansible.com/ansible/latest/user_guide/intro_inventory.html[Ansible's documentation] for further details about Ansible inventories.
