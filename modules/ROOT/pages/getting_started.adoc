...
Password:
Login Succeeded
$ docker pull quay.io/bonitasoft/bcd-controller:3.5.0
[...]
Status: Downloaded newer image for quay.io/bonitasoft/bcd-controller:3.5.0

$ cd $HOME/bonita-continuous-delivery_3.5.0/dependencies
