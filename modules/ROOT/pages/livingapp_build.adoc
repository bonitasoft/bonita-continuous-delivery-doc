...
The next step is to provide all dependencies required to build your repository, see xref:getting_started.adoc#installation-guide[Common Installation Steps].
