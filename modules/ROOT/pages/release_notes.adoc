...
== What's new in 3.4.4
Stack and license commands are deprecated.  These commands used for infrastructure provision were rarely adapted to the diversity of stacks.

We've decided to solely focus on the continuous integration to help you where we can the most impact: Build and deploying easily your automation projects.

BCD Stack and license commands will be removed in the up-coming BCD versions.

If you have managing your stacks with BCD, we recommend using the following tools to replace BCD for your provisionning:
