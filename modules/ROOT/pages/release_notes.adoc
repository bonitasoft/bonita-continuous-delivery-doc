...
- New documentation page on how to build and deploy Living Apps without stack management. see xref:livingapp_build_and_deploy_no_stack.adoc[Build and deploy "without stack"]
