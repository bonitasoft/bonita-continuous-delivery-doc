...
[TIP]
====
If you don't feel like managing infrastructure at all anymore, you may also want to have a look at our Cloud hosted offer (which include a ready to use CI solution) : image:https://www.bonitasoft.com/system/files/Cloud/bonita_cloud_200.png["Bonita Cloud",30,30] https://www.bonitasoft.com/bonita-cloud
====
