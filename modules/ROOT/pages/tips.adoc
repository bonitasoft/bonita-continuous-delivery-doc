...
It uses the xref:{bonitaDocVersion}@bonita:build-run:build-application.adoc[Bonita Application maven build] and the xref:deployer.adoc[Bonita Application Deployer].
...
* you have cloned a Git repository and are ready to build the project as described in the xref:{bonitaDocVersion}@bonita:build-run:build-application.adoc[Bonita Maven Build] documentation
