...
:description: BCD Troubleshooting. Troubleshooting regarding Bonita Artifact repository or network access.
...
* If you don't need a special file encoding, ensure the project is configured to use UTF-8 file encoding. The project `pom.xml` file should content these lines:
[code,xml]
----
<properties>
